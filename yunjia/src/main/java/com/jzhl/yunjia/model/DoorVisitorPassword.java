...
/**
 * door_visitor_password
 * @author 
 */
public class DoorVisitorPassword implements Serializable {
    /**
     * id
     */
    private Integer id;
    ...
    public boolean equals(Object that) {
        ...
        DoorVisitorPassword other = (DoorVisitorPassword) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getEffectiveHours() == null ? other.getEffectiveHours() == null : this.getEffectiveHours().equals(other.getEffectiveHours()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getEffectiveHours() == null) ? 0 : getEffectiveHours().hashCode());
